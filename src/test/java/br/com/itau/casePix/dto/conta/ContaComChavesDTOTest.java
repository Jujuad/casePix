...
public class ContaComChavesDTOTest {
    ...
    @Test
    public void testValidContaComChavesDTO() {
        ContaComChavesDTO conta = new ContaComChavesDTO();
    ...
    @Test
    public void testInvalidContaComChavesDTO() {
        ContaComChavesDTO conta = new ContaComChavesDTO();
